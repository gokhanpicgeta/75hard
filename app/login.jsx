      ...
      if (isSignup) {
        ...
        if (userSnap.exists()) {
          ...
          await AsyncStorage.setItem(
            "currentAttempt",
            JSON.stringify(userSnap.data().currentAttempt)
          );
          await AsyncStorage.setItem(
            "prevAttempts",
            JSON.stringify(userSnap.data().prevAttempts)
          );

          await AsyncStorage.setItem(
            "attemptNumber",
            JSON.stringify(userSnap.data().attempts)
          );

          const challengesObject =
            userSnap.data().currentAttempt?.id_to_task || [];
          const challenges = challengesObject.map(
