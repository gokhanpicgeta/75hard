...
export default function FriendRequestsRecieved() {
  ...
  return (
    <View style={styles.modalContainer}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Recieved Friend Requests</Text>
          ...
          friendRequests.map((request) => (
            <View key={request.id} style={styles.requestCard}>
              <Text style={styles.requestText}>
                {request.fromUsername || "Unknown User"} sent you a request
              </Text>
              <View style={styles.actionButtons}>
                <TouchableOpacity
                  onPress={() => handleAcceptRequest(request.id, request.from)}
